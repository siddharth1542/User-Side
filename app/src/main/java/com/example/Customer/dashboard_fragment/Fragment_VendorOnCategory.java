...
public class Fragment_VendorOnCategory extends Fragment {
    ...
    @BindView(R.id.vendor_Cat_Recycler)
    ...
    public Fragment_VendorOnCategory(String CAT_id)
    {
        this.cat_id = CAT_id;
    }
    ...
    private void getVendorlistNoPara(String catid)
    {
        String pageindex = "0";
...
//
//                        }
//                        vendor_adapter = new Vendor_Adapter(demoArr,getContext());
